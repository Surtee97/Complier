...
int addSymbol(char *symbol) {
    ...
    symbolTable[symbolCount] = strdup(symbol);
    return symbolCount++;
}
...
{
      28,     0,    -1,    22,    29,    18,    31,    19,    -1,    23,
       8,    24,    30,    12,    29,    -1,    -1,    13,    -1,    14,
      -1,    32,    12,    31,    -1,    -1,    33,    -1,    34,    -1,
      36,    -1,    37,    -1,     8,    11,    38,    -1,     8,    11,
      26,    -1,    15,    38,    16,    31,    35,    19,    -1,    17,
      31,    -1,    -1,    20,    38,    21,    31,    19,    -1,    25,
      38,    -1,    39,    -1,    39,     7,    39,    -1,    40,     6,
      40,    -1,    40,    -1,    41,     5,    41,    -1,    41,    -1,
       8,    -1,     3,    -1,     4,    -1,     9,    38,    10,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    64,    64,    75,    76,    79,    80,    83,    84,    87,
      88,    89,    90,    93,    94,    97,   100,   101,   104,   107,
     110,   111,   114,   115,   118,   119,   122,   123,   127,   128
};
#endif
...
/* Line 1455 of yacc.c  */
#line 64 "parser.y"
    { (yyval.nPtr) = opr(PROGRAM, 3, (yyvsp[(2) - (5)].nPtr), (yyvsp[(4) - (5)].nPtr),str("end"));
	printf("\n-- Generated code -- \n\n");
...
/* Line 1455 of yacc.c  */
#line 75 "parser.y"
    { (yyval.nPtr) = opr(AS, 4, (yyvsp[(4) - (6)].nPtr),var((yyvsp[(2) - (6)].sString)),opr(SC,0),(yyvsp[(6) - (6)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 93 "parser.y"
    { (yyval.nPtr) = opr(ASGN, 2, var((yyvsp[(1) - (3)].sString)), (yyvsp[(3) - (3)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 94 "parser.y"
    { (yyval.nPtr) = opr(ASGN, 2, var((yyvsp[(1) - (3)].sString)), opr(READINT,0)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 97 "parser.y"
    { (yyval.nPtr) = opr(IF, 4, (yyvsp[(2) - (6)].nPtr), (yyvsp[(4) - (6)].nPtr), (yyvsp[(5) - (6)].nPtr), str("end"));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 100 "parser.y"
    { (yyval.nPtr) = opr(ELSE, 1, (yyvsp[(2) - (2)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 104 "parser.y"
    { (yyval.nPtr) = opr(WHILE, 3, (yyvsp[(2) - (5)].nPtr), (yyvsp[(4) - (5)].nPtr),str("end")); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 107 "parser.y"
    { (yyval.nPtr) = opr(WRITEINT, 1, (yyvsp[(2) - (2)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 122 "parser.y"
    { (yyval.nPtr) = var((yyvsp[(1) - (1)].sString)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 123 "parser.y"
    { (yyval.nPtr) = lit((yyvsp[(1) - (1)].iValue));
		if(!((yyvsp[(1) - (1)].iValue) >=-2147483647 && (yyvsp[(1) - (1)].iValue) <= 2147483647)) {
...
/* Line 1455 of yacc.c  */
#line 127 "parser.y"
    { (yyval.nPtr) = lit((yyvsp[(1) - (1)].bValue)); ;}
    break;
	...
	switch(p->type){
		...
		case typeOp:{
				...
				case 267: // add semicolon
					addToBuffer(buffer,getStringForConstant(p->op.operation), BUFFER_SIZE);
					break;
				case 266: // add equals
					{					
